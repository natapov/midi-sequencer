...
bool ImGui::MyButton(const char* label, const ImVec2& size_arg)
{
	return ButtonEx(label, size_arg, ImGuiButtonFlags_PressedOnClick);
}
...
enum : char{
	...
	state_middle = 2,
	state_end    = 4,
	state_min    = state_end | state_start,
};
...
void ImGui::TextBox(const char* label, const ImVec2& size_arg, const ImVec2& TextAlignment, ImU32 box_col)
{
	...
	ImRect bb(pos.x, pos.y, pos.x + size_arg.x, pos.y + size_arg.y);
