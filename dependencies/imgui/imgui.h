...
namespace ImGui
{
	...
	IMGUI_API bool          MyButton(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
	...
	IMGUI_API void          Cell(char state = 0, const ImVec2& size = ImVec2(0, 0), int border = 0, ImU32 note_col = 0, ImU32 border_col = 0); // "bool selected" carry the selection state (read-only). Selectable() is clicked is returns true so you can modify your selection state. size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height
	IMGUI_API void          TextBox(const char* label, const ImVec2& size = ImVec2(0, 0), const ImVec2& TextAlignment = ImVec2(0, 0), const ImU32 box_col = 0); // "bool selected" carry the selection state (read-only). Selectable() is clicked is returns true so you can modify your selection state. size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height
